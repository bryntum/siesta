...
//
// //---------------------------------------------------------------------------------------------------------------------
// export class ChannelPuppeteer extends Mixin(
//     [ Channel, Base ],
//     (base : ClassUnion<typeof Channel, typeof Base>) => {
//
//         class ChannelPuppeteer extends base {
//             childMediaClassUrl      : string                = import.meta.url
//                 .replace(/channel\/ChannelPuppeteer.js$/, 'media/MediaBrowserMessagePort.js')
