...
StartTest(t => {
    ...
    t.it('Deep compare should work for primitives and non-cyclic data structures', async t => {
    ...
    t.it('Deep compare should work with sets of objects', async t => {
    ...
    t.it('Deep compare should work with maps with key objects', async t => {
    ...
    t.it('Deep compare should work with circular data structures', async t => {
        ...
        t.isDeeply(CI(compareDeepGen(a1, a3)).toArray(), [ t.any(DifferenceReachability) ])
